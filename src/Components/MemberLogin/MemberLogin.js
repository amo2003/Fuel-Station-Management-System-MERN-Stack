...
import logo from '../../assets/f2.png';  // Your logo file
import bgImage from '../../assets/f1.jpg'; // Your background image file
    ...
    >
      <div className="member-login-box">
        ...
        <p className="register-link">
          Don’t have an account? <Link to="/addmember">Register here</Link>
        </p>
      </div>
    </div>
  );
